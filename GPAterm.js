...
function addInput() {
    ...
    inputGroup.innerHTML = `
        <span></span>
        <input type="text" placeholder="ใส่ชื่อวิชา (ไม่จำเป็น)">
        <input type="number" class="value1" placeholder="ใส่หน่วยกิต" step="0.5" min="0.5" max="5">
        <input type="number" class="value2" placeholder="ใส่เกรด" step="0.5" min="0" max="4">
